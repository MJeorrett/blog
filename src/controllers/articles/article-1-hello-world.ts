...
export let article1 = (req: Request, res: Response) => {
    res.send(
        ...
        "<p>I am Developer Evangelist at <a href='wallet.services'>Wallet.Services</a> where I mostly write C# and typescript. " +
        ...
        "<p>This page is quite basic (as you may have noticed!).  I have started with a really simple a setup: a " +
        "<a href='https://nodejs.org/en/'>node</a> back end running an <a href='https://expressjs.com/'>express</a> server " +
        ...
        "development of the blog: <b>inception!</b>.  While I head off to see if I can get this inception idea rolling I'll leave you " +
        "with a picture; my marketing colleague <a href='https://www.youtube.com/channel/UCQqGVT3Lip_IYMvg6syADDw'>Blockchain Beyonce</a> " +
        " told me that blogs with pictures get more readers...</p>" +
